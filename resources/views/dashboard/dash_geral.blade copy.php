            ...
            <div class="col-lg-3 col-12">
                ...
                <div class="info-box bg-gradient-light card-clickable">
                    ...
                    <div class="info-box-content">
                        <span class="info-box-text">Padre Mororó</span>
                ...
                <div class="info-box bg-gradient-light card-clickable">
                    <span class="info-box-icon" style="color:{{ $corEquip3['cor'] }}"><i
                            class="fa fa-bookmark"></i></span>
                    <div class="info-box-content">
                        <span class="info-box-text">São Vicente de Paula</span>
            ...
            <div class="row">
                ...
                <div class="col-md-3 col-sm-6 col-12">
                    <div class="info-box">
                        ...
                        <div class="info-box-content">
                            <span class="info-box-text">Insegurança Alimentar</span>
                ...
                <div class="col-md-3 col-sm-6 col-12">
                    <div class="info-box">
                        ...
                        <div class="info-box-content">
                            <span class="info-box-text">Situação de Rua</span>
